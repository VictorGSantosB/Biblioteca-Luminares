...
<main class="min-h-screen">
    @guest
        <div class="flex-col lg:flex-row items-center flex justify-between items-center px-5 h-[500px] mx-[20px]">
            <div
                class="w-1/2 mt-10 md:justify-center md:items-center sm:text-center md:text-center sm:mx-auto md:mx-auto">
            ...
            <span>
                <img src="{{ asset('img/NAVBARLOGO.png') }}" alt="">
            </span>
        </div>
    @endguest
                    ...
                    <div class="group">
                        <div
                            ...
                            <img src="/img/books/{{$book->image}}"
                                ...
                                class="h-full w-full object-cover object-center lg:h-full lg:w-full z-0">
                        </div>
                        <div class="mt-4 flex justify-between">
                            ...
                            <div class="flex space-x-4">
                                @if (Auth::id() == 1)
                                    <form method="GET" action="{{ route('book.form.update', $book->id) }}">
                                        <button type="submit" class="text-sm font-medium text-gray-900">Update</button>
                                    </form>
